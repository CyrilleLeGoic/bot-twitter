...
#send_message
  ...
  #def ca_va_liker
    ...
    #requete = client.search("#bonjour_monde", result_type: "recent").take(30)
    #client.favorite(requete)
...
#def ca_va_follow
  ...
  #client = login_twitter
  #search = client.search("#bonjour_monde", result_type: "recent").take(30)
  #screen_names = search.collect {|tweet| tweet.attrs[:user][:screen_name]}
  #screen_names = screen_names.delete_if{|id| id=="GoicCyrille"}.uniq
